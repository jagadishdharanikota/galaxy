import {
  getItemType1ActionAndAfterState,
  getItemType2ActionAndAfterState,
  getItemType3ActionAndAfterState,
} from './viewGroupData';
...
let viewGroupReducer;

// Importing module asynchronosly before all the tests are ran
beforeAll(async (done) => {
  viewGroupReducer = await loadModuleAsync(dependencyFilePath);
  done();
});
